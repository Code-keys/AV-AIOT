...
// On the resulting element, usually an encoder or muxer, you can use gst_tag_setter_merge_tags () with a taglist or 
// gst_tag_setter_add_tags () with individual tags, to set tags on it.